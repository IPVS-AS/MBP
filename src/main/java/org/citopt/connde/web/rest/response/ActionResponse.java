 ...
 */
@ApiModel(description = "Response to requests for executing a certain action.")
public class ActionResponse {
	...
	// Messages that contain specific information about individual involved components (field -> error message)
	...
	/**
	 * Adds a field specific error message to the response object that describes the
	 * issue that occurred while executing the action because of this field (e.g.
	 * validation issues).
	 *
	...
	/**
	 * Sets a map (field name --> error message) that contains error messages which
	 * describe the issue that occurred because of certain fields while executing
	 * the action (e.g. validation issues).
	 *
	...
	/**
	 * Returns a map (field name --> error message) that contains error messages
	 * which describe the issue that occurred because of certain fields while
	 * executing the action (e.g. validation issues).
	 *
