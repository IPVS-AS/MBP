...
@Api(tags = {"Deployment"}, description = "Manages the deployment of actuators and sensors")
public class RestDeploymentController implements ResourceProcessor<RepositoryLinksResource> {
    ...
    public ResponseEntity<ActionResponse> startActuator(@PathVariable(value = "id") @ApiParam(value = "ID of the actuator", example = "5c97dc2583aeb6078c5ab672") String id,
    ...
    public ResponseEntity<ActionResponse> startSensor(@PathVariable(value = "id") @ApiParam(value = "ID of the sensor", example = "5c97dc2583aeb6078c5ab672") String id,
                                                      @RequestBody @ApiParam(value = "List of deployment parameter instances to use") List<ParameterInstance> parameters) {
    ...
    public ResponseEntity<ActionResponse> stopActuator(@PathVariable(value = "id") @ApiParam(value = "ID of the actuator", example = "5c97dc2583aeb6078c5ab672") String id) {
    ...
    public ResponseEntity<ActionResponse> stopSensor(@PathVariable(value = "id") @ApiParam(value = "ID of the sensor", example = "5c97dc2583aeb6078c5ab672") String id) {
    ...
    public ResponseEntity<Boolean> isRunningActuator(@PathVariable(value = "id") @ApiParam(value = "ID of the actuator", example = "5c97dc2583aeb6078c5ab672") String id) {
    ...
    public ResponseEntity<Boolean> isRunningSensor(@PathVariable(value = "id") @ApiParam(value = "ID of the sensor", example = "5c97dc2583aeb6078c5ab672") String id) {
    ...
    public ResponseEntity<ActionResponse> deployActuator(@PathVariable(value = "id") @ApiParam(value = "ID of the actuator", example = "5c97dc2583aeb6078c5ab672") String id) {
    ...
    public ResponseEntity<ActionResponse> deploySensor(@PathVariable(value = "id") @ApiParam(value = "ID of the sensor", example = "5c97dc2583aeb6078c5ab672") String id) {
    ...
    public ResponseEntity<ActionResponse> undeployActuator(@PathVariable(value = "id") @ApiParam(value = "ID of the actuator", example = "5c97dc2583aeb6078c5ab672") String id) {
    ...
    public ResponseEntity<ActionResponse> undeploySensor(@PathVariable(value = "id") @ApiParam(value = "ID of the sensor", example = "5c97dc2583aeb6078c5ab672") String id) {
