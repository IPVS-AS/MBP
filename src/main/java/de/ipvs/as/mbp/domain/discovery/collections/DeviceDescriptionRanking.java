 ...
 * can be calculated for each device description with respect to a given {@link DeviceTemplate}.
 */
public class DeviceDescriptionRanking implements Queue<DeviceDescription> {
    ...
    public void setDeviceTemplate(DeviceTemplate deviceTemplate) {
        ...
        //There are elements in the current queue, so remember them
     ...
     *
     * @param deviceDescription the element to add
    ...
    public boolean add(DeviceDescription deviceDescription) {
        ...
        if (deviceDescription == null) {
            throw new IllegalArgumentException("The device descriptoon must not be null.");
        }

        return this.queue.add(deviceDescription);
    }
     ...
     */
    @Override
    public boolean offer(DeviceDescription deviceDescription) {
        //Null check
        if (deviceDescription == null) {
            throw new IllegalArgumentException("The device description must not be null.");
        }

        //Offer the device description to the queue
        return this.queue.offer(deviceDescription);
    }
     ...
     */
    @Override
    public DeviceDescription remove() {
     ...
     */
    @Override
    public DeviceDescription element() {
