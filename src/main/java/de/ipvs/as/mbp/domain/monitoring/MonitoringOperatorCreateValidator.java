...
/**
 * Creation validator for monitoring operator entities.
 */
@Service
public class MonitoringOperatorCreateValidator implements ICreateValidator<MonitoringOperator> {
     ...
     */
    @Override
    public void validateCreatable(MonitoringOperator entity) {
        //Sanity check
        if (entity == null) {
