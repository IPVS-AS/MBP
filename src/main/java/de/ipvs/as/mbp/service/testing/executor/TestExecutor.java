...
public class TestExecutor {
    ...
    private void analyzeTest(TestDetails test, List<Rule> rulesBefore) throws Exception {
        ...
        TestDetails testDetails = testDetailsRepository.findById(test.getId()).get();
     ...
     */
    public void startSensors(Sensor testSensor, List<ParameterInstance> parameterValues) {
    ...
    private void startActuator() {
        ...
        Actuator testingActuator = actuatorRepository.findByName(TESTING_ACTUATOR).get();
