...
/**
 * This component is able to process a given {@link CandidateDevicesContainer}, consisting out of multiple
...
public class CandidateDevicesProcessor {
    ...
    /**
     * Processes a given {@link CandidateDevicesContainer} by filtering out invalid candidate devices
     ...
     *
     * @param candidateDevices The {@link CandidateDevicesContainer} containing the candidate devices to process
     ...
     */
    public CandidateDevicesRanking process(CandidateDevicesContainer candidateDevices, DeviceTemplate deviceTemplate) {
        //Sanity checks
