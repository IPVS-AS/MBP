...
/**
 * By using this comparator, a collection or stream of candidate devices, given as {@link DeviceDescription}s,
 * can be sorted such that the devices with the more recent last update timestamps appear earlier than
 * the ones with later timestamps.
 */
public class CandidateDevicesTimestampComparator implements Comparator<DeviceDescription> {
