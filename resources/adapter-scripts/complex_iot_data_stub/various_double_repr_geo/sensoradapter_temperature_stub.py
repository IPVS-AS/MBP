...
def main(argv):
   ...
   try:  
      while True:
         ...
         msg_pub = {"component": component.upper(), "id": component_id, "value": {"val1": random.uniform(5.0, 85.0), "arr1": [random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0)], "arr2": [[random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0)], [random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0)], [random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0)], [random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0)]], "arr4": [{"arr5": [random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0)]}, {"arr5": [random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0)]}, {"arr5": [random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0)]}, {"arr5": [random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0), random.uniform(5.0, 85.0)]}]}}
