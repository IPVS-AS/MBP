# Extraction Operator: Parametrized scripts to simulate the Z-axis (Hight) of a GPS sensor

This folder contains operator scripts to simulate data of the Z-axis (Hight) of a GPS sensor. The simulator can be used in the case of an IoT-Application where actions should be triggered on approaching or moving away from a  Smart Home.     
