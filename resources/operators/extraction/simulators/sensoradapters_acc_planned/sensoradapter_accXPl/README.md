# Extraction Operator: Parametrized scripts plann the simulation of the data of a X-axis of a acceleration sensor

This folder contains operator scripts for a planned simulation of sensor data of the X-axis of an acceleration sensor, where the simulation time and number of events and anomalies can be scheduled. The simulator can be used in the context of an alarm sytem, where a object has to be observed.
